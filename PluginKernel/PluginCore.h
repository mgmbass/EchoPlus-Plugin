...
public:
	...
	double recordLevel_cooked = 0;
	double playbackLevel_cooked = 0;
	double noiseLevel_cooked = 0;
...
private:
	...
	double noiseFilter_Hz = 0.0;
	float lowFreqAmp = 0.f;
	double noiseAmp = 0.0;
	double noisemodDepth = 0.0;
	double lfoModDepth = 0.0;
	float wetMix = 0.f;
	double dryMix = 0.0;
	double feedBack_pct = 0.0;
	double noiseLevel_dB = 0.0;
	double recordLevel_dB = 0.0;
	double playbackLevel_dB = 0.0;
	double noiseOutFIlter = 0.0;
