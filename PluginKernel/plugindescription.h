...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_9767741271F74A5BB2A48763018022EB
#define AU_COCOA_VIEW_NAME AUCocoaView_9767741271F74A5BB2A48763018022EB
...
const char* kAAXBundleID = "rackafxuser.aax.Echoplex.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.Echoplex.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.Echoplex.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "Echoplex";     // 31 chars max for AAX
const char* kShortPluginName = "Echoplex";    // 15 chars max for AAX
const char* kAUBundleName = "Echoplex";
...
const char* kVSTFUID = "{97677412-71F7-4A5B-B2A4-8763018022EB}"; /// NOTE: you need the enclosing { }
